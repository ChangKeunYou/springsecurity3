	...
	<table border="1">
		...
		<c:forEach items="${itemList}" var="item">
			<tr class="record">
				...
				<td align="center"><a href="<c:url value="confirm.html"><c:param name="itemId" value="${item.itemId}"></c:param></c:url>">상품 제거</a></td>
				 
			</tr>
		</c:forEach>
	</table>
	<br>
	<a href="<%=root%>/j_spring_security_logout">■로그아웃하기</a>
	<a href="<c:url value="test.html"><c:param name="itemId" value="9985"></c:param></c:url>">테스트페이지이동</a>
	</div>
